...
def main(n: int, order_date: str, batch_size=10000, n_processes=8):
    conn = DBConnection()
    generator = DataGenerator(conn)
    generator.generate_sales_data_multiprocessing(n=n, order_date=order_date, batch_size=batch_size, n_processes=n_processes)
...
if __name__ == "__main__":
    ...
    main(n=args.n_orders, order_date=args.order_date, n_processes=args.n_processes)
    end_time = time.time()
